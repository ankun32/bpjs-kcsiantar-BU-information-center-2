...
const i18n = {
  ...
  id: {
    ...
    sec_keltam_title: 'Brosur Keluarga Tambahan 1%',
    sec_keltam_desc : 'Anak ke-4 dan seterusnya, orang tua, serta mertua dari peserta PPU dapat didaftarkan sebagai peserta JKN dengan tambahan iuran 1% dari gaji per orang per bulan.',
    tag_brosur      : 'Brosur',
    tag_syarat      : 'Syarat Berkas',
    keltam_brosur_title: 'Info Iuran Keluarga Tambahan 1%',
    keltam_bu_title : 'PPU BU (Badan Usaha)',
    keltam_bu_desc  : 'Untuk pekerja swasta / BUMN / BUMD. Pendaftaran diajukan secara kolektif melalui HRD / Personalia badan usaha.',
    keltam_bu_1     : 'Fotokopi/salinan Kartu Keluarga (KK) terbaru',
    keltam_bu_2     : 'Fotokopi KTP/KIA anggota keluarga tambahan yang akan didaftarkan',
    keltam_bu_3     : 'Surat Kuasa Pemotongan Gaji (iuran tambahan 1%) dari pekerja kepada perusahaan',
    keltam_bu_4     : 'Formulir Daftar Isian Peserta yang diserahkan ke HRD / Personalia',
    keltam_bu_5     : 'Pelunasan tunggakan terlebih dahulu jika sebelumnya terdaftar sebagai peserta Mandiri (PBPU)',
    keltam_pn_title : 'PPU PN (PNS Pusat, TNI, POLRI, P3K Pusat)',
    keltam_pn_desc  : 'Untuk Penyelenggara Negara. Pendaftaran diajukan secara kolektif melalui bendahara gaji / satuan kerja (satker) instansi.',
    keltam_pn_1     : 'Fotokopi/salinan Kartu Keluarga (KK) yang menunjukkan hubungan keluarga (orang tua/mertua/anak)',
    keltam_pn_2     : 'Fotokopi KTP anggota keluarga tambahan yang akan didaftarkan',
    keltam_pn_3     : 'Salinan daftar gaji / slip gaji terakhir',
    keltam_pn_4     : 'Surat Kuasa Pemotongan Gaji (1%) dari pegawai kepada PPK/KPA satuan kerja',
    keltam_pn_5     : 'Surat pengantar dari instansi, diproses kolektif oleh bendahara gaji',
    keltam_note     : 'Iuran tambahan 1% dihitung dari gaji/penghasilan tetap per orang per bulan, dengan batas maksimal penghasilan sebagai dasar perhitungan Rp12.000.000. Untuk konfirmasi kelengkapan berkas dan simulasi iuran, silakan hubungi petugas kami.',
    ...
    ro_sml3_name : 'AdesafRiko Manurung',
  ...
  en: {
    ...
    gal8_cap: 'Educational Visit to Business Entities',
    gal9_cap: 'Coordination Meeting with Business Entities',
    gal10_cap: 'Monitoring and Evaluation of Business Entity Membership',

    /* Additional Family Members 1% Section */
    sec_keltam_tag  : 'Additional Contribution',
    sec_keltam_title: '1% Additional Family Members Brochure',
    sec_keltam_desc : 'A PPU participant\u2019s 4th child onward, parents, and parents-in-law can be registered as JKN participants with an additional 1% contribution of salary per person per month.',
    tag_brosur      : 'Brochure',
    tag_syarat      : 'Required Documents',
    keltam_brosur_title: '1% Additional Family Members Info',
    keltam_bu_title : 'PPU BU (Business Entity)',
    keltam_bu_desc  : 'For private / state-owned / regional-owned company employees. Registration is submitted collectively through the company\u2019s HR / Personnel department.',
    keltam_bu_1     : 'Copy of the latest Family Card (KK)',
    keltam_bu_2     : 'Copy of ID (KTP/KIA) of the additional family member to be registered',
    keltam_bu_3     : 'Salary Deduction Power of Attorney (1% additional contribution) from the employee to the company',
    keltam_bu_4     : 'Participant Data Form submitted to HR / Personnel',
    keltam_bu_5     : 'Any outstanding arrears must be settled first if the family member was previously registered as an Independent (PBPU) participant',
    keltam_pn_title : 'PPU PN (Central Civil Servants, TNI, POLRI, Central P3K)',
    keltam_pn_desc  : 'For State Officials. Registration is submitted collectively through the payroll treasurer / work unit (satker) of the institution.',
    keltam_pn_1     : 'Copy of the Family Card (KK) showing the family relationship (parent/parent-in-law/child)',
    keltam_pn_2     : 'Copy of ID (KTP) of the additional family member to be registered',
    keltam_pn_3     : 'Copy of the latest payroll / salary slip',
    keltam_pn_4     : 'Salary Deduction Power of Attorney (1%) from the employee to the work unit\u2019s PPK/KPA',
    keltam_pn_5     : 'Cover letter from the institution, processed collectively by the payroll treasurer',
    keltam_note     : 'The 1% additional contribution is calculated from the fixed salary/income per person per month, with a maximum income cap of Rp12,000,000 used as the calculation base. For document completeness confirmation and contribution simulation, please contact our staff directly.',
